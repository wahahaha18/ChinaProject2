...
public class MaintainPlanAdapter extends BaseQuickAdapter<MaintainPlan, BaseViewHolder> {
    public MaintainPlanAdapter(List<MaintainPlan> data) {
    ...
    protected void convert(BaseViewHolder helper, MaintainPlan item) {
        ...
        helper.setText(R.id.tv01, String.valueOf(helper.getLayoutPosition() + 1))//序号
                .setText(R.id.tv02, item.getEquip().getEqname())//设备名称
                .setText(R.id.tv03, item.getEquip().getEqno())//设备编号
                .setText(R.id.tv04, item.getO().getPlandate())//计划保养时间
                .setText(R.id.tv05, item.getO().getPmark())//注意事项
                .setText(R.id.tv06, info)//操作指导
                .setText(R.id.tv07, item.getO().getPmcontent())//保养内容
