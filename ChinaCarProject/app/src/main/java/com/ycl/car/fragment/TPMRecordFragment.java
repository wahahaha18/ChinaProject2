...
import com.ycl.car.contract.TPMRecordContract;
...
import com.ycl.car.presenter.TPMRecordPresenter;
...
public class TPMRecordFragment extends BasePageFragment implements TPMRecordContract.View {
    public static TPMRecordFragment newInstance(Bundle bundle) {

        TPMRecordFragment fragment = new TPMRecordFragment();
        fragment.setArguments(bundle);
        return fragment;
    }

    private TPMRecordPresenter presenter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bundle = getArguments();
        presenter = new TPMRecordPresenter(this);
    ...
    @Override
    public void setPresenter(TPMRecordContract.Presenter presenter) {
