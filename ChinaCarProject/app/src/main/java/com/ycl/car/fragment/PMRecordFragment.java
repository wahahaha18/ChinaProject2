...
public class PMRecordFragment extends BasePageFragment implements PMRecordContract.View {
    public static PMRecordFragment newInstance(Bundle bundle) {

        PMRecordFragment fragment = new PMRecordFragment();
